        ...
        <div class="container h-100">
          <div class="row align-items-center h-100">
              <div class="col-md-12 text-center">
                <h2 class="slide-title" data-animation-in="slideInLeft"><?php echo get_the_title();?></h2>
                <h3 class="slide-sub-title" data-animation-in="slideInRight"><?php echo get_field('sub_title');?></h3>
                <p data-animation-in="slideInLeft" data-duration-in="1.2"><?php echo get_the_content();?> </p>
                <p>
                    <a href="<?=  get_field('button_link'); ?>" class="slider btn btn-primary"><?php echo get_field('button_text');?></a>
  </p>
